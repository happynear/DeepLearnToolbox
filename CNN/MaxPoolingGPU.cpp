 ...
 */
template <typename T>
void mexMaxPoolingGPU(int nlhs, mxGPUArray *plhs[], int nrhs, const mxArray *prhs[], mxClassID classID)
{
...
void mexFunction(int nlhs, mxGPUArray *plhs[], int nrhs, const mxGPUArray *prhs[])
{
  /***************************************************************************/
  /** Check input ************************************************************/
  /***************************************************************************/
  ...
  if (classID == mxSINGLE_CLASS) {
      ...
      mexMaxPoolingGPU<float>(nlhs, plhs, nrhs, prhs, classID);
  }  else if (classID == mxDOUBLE_CLASS) {
      if (debug)
        fprintf(stderr, "Executing the double version\n");

      mexMaxPoolingGPU<double>(nlhs, plhs, nrhs, prhs, classID);
  }
  else{
	  mexMaxPoolingGPU<double>(nlhs, plhs, nrhs, prhs, classID);
  }
